    ...
    return (
        ...
        >
            <a
                ...
                className="group relative inline-flex items-center justify-center px-6 py-2.5 border border-white/10 bg-white/5 rounded-full backdrop-blur-md font-sans text-xs font-medium tracking-widest uppercase text-white transition-all duration-500 hover:border-cyan-500/40 hover:shadow-[0_0_20px_rgba(34,211,238,0.15)] overflow-hidden"
            >
