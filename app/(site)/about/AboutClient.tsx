...
export default function AboutClient({ featuredProjects }: { featuredProjects: Project[] }) {
    return (
                                        ...
                                        {[
                                            ...
                                            >
                                                <Image
                                                    ...
                                                    width={42}
                                                    height={42}
                                                    className={["relative z-10 h-8 w-8 object-contain"].join(" ")}
                                                />
                                            </motion.div>
                                        ))}
                                    </div>
                        ...
                        <Link href={`/works/${project.id}`} key={project.id} className="group block">
                            ...
                            >
                                ...
                                <div className="relative aspect-[16/10] w-full overflow-hidden rounded-2xl bg-zinc-950">
                                    <ImageWithSkeleton
                                        src={getPreferredMediaUrl(project.image, 'original') || "/images/profile-photo.jpg"}
                                        alt={project.title}
                                        fill
                                        unoptimized={true}
